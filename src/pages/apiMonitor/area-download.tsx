...
export default function AreaDownload() {
	...
	const series: Record<string, ApexAxisChartSeries> = {
		"2022": [
			{ name: "App A", data: [10, 41, 35, 51, 49, 61, 69, 91, 148, 35, 51] },
			{ name: "App B", data: [10, 34, 13, 56, 77, 88, 99, 45, 13, 56, 77] },
		],

		"2023": [
			{ name: "App A", data: [51, 35, 41, 10, 91, 69, 62, 148, 91, 35, 51] },
			{ name: "App B", data: [56, 13, 34, 10, 77, 99, 88, 45, 13, 56, 77] },
		],
	};
	return (
		<Card className="flex-col">
			<header className="flex w-full justify-between self-start">
				<Typography.Title level={5}>API requests over time</Typography.Title>
				<Select
					size="small"
					defaultValue={year}
